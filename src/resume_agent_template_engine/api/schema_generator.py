            ...
            "properties": {
                "personalInfo": {
                    ...
                    "properties": {
                        ...
                        "twitter": {"type": "string", "format": "uri", "description": "Twitter profile URL"},
                        "x": {"type": "string", "format": "uri", "description": "X (formerly Twitter) profile URL"},
                        "website_display": {"type": "string", "description": "Display text for website"},
                        "linkedin_display": {"type": "string", "description": "Display text for LinkedIn"},
                        "github_display": {"type": "string", "description": "Display text for GitHub"},
                        "twitter_display": {"type": "string", "description": "Display text for Twitter"},
                        "x_display": {"type": "string", "description": "Display text for X"}
                    }
                },
                "professionalSummary": {
                    "type": "string",
                ...
                "experience": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "startDate": {"type": "string", "pattern": "^\\d{4}-\\d{2}(-\\d{2})?$", "description": "Start date (YYYY-MM or YYYY-MM-DD)"},
                            "endDate": {"type": "string", "description": "End date (YYYY-MM, YYYY-MM-DD, or 'Present')"},
                ...
                "education": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "graduationDate": {"type": "string", "pattern": "^\\d{4}-\\d{2}(-\\d{2})?$", "description": "Graduation date"},
                            "gpa": {"type": "string", "description": "Grade point average"},
                            "coursework": {"type": "array", "items": {"type": "string"}, "description": "Relevant coursework"},
                            "honors": {"type": "array", "items": {"type": "string"}, "description": "Academic honors"}
                        }
                    }
                },
                "projects": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "achievements": {"type": "array", "items": {"type": "string"}, "description": "Project achievements"}
                        }
                    }
                },
                "skills": {
                    ...
                    "properties": {
                        ...
                        "tools": {"type": "array", "items": {"type": "string"}, "description": "Tools and software"}
                    }
                },
                "certifications": {
                    "type": "array",
            ...
            "properties": {
                ...
                "recipient": {
                    ...
                    "properties": {
                        ...
                        "address": {"type": ["string", "array"], "items": {"type": "string"}, "description": "Address lines"},
                ...
                "date": {"type": "string", "description": "Letter date (auto-generated if not provided)"},
                "salutation": {"type": "string", "description": "Letter greeting (auto-generated if not provided)"},
                "body": {
                    "type": ["string", "array"],
                    "items": {"type": "string"},
                    "description": "Letter body content (string or array of paragraphs)"
                },
                "closing": {"type": "string", "description": "Letter closing (auto-generated if not provided)"}
            }
        }
