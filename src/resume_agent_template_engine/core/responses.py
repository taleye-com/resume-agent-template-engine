...
class ValidationResponse:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result = {
            ...
            "warnings": [self._error_detail_to_dict(warning) for warning in self.warnings]
        }
...
class ResponseFormatter:
    ...
    @staticmethod
    def get_http_status_code(exception: Union[ResumeCompilerException, Exception]) -> int:
