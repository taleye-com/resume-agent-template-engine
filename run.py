...
def run_ui():
    subprocess.run(["streamlit", "run", "src/resume_agent_template_engine/ui/streamlit_app.py", "--server.port", "8502", "--server.address", "0.0.0.0", "--browser.gatherUsageStats", "false"])
...
def main():
    ...
    parser.add_argument("--all", action="store_true", help="Run both the API and UI servers")
