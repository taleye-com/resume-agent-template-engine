...
class SampleDataFactory:
    ...
    def create_skills_section(
        ...
        return {
            ...
            or ["Python", "JavaScript", "TypeScript", "Java", "Go"],
            "frameworks": frameworks
            or ["FastAPI", "React", "Node.js", "Django", "Flask"],
            "databases": databases or ["PostgreSQL", "MongoDB", "Redis", "MySQL"],
            "tools": tools or ["Docker", "Kubernetes", "AWS", "Git", "Jenkins"],
            "soft_skills": soft_skills
            or ["Leadership", "Communication", "Problem Solving", "Team Collaboration"],
        }
...
MINIMAL_RESUME_DATA = {"personalInfo": SampleDataFactory.create_personal_info()}
...
SAMPLE_RESUME_DATA_MULTILANG = {
    ...
    "es": SampleDataFactory.create_complete_resume_data(
        personal_info=SampleDataFactory.create_personal_info(
            name="Juan Pérez", email="juan.perez@ejemplo.com", location="Madrid, España"
        ),
...
def get_sample_data(data_type: str, variant: str = "default") -> dict[str, Any]:
    ...
    data_map = {
        ...
        "cover_letter": {"default": SAMPLE_COVER_LETTER_DATA},
        "personal_info": {"default": SAMPLE_PERSONAL_INFO},
    }
