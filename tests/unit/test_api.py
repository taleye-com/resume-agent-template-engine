...
from resume_agent_template_engine.api.app import app, validate_date_format, validate_resume_data
...
class TestAPIEndpoints:
    ...
    def test_list_templates_by_type_not_found(self, mock_engine_class, client):
        ...
        mock_engine = Mock()
        mock_engine.get_available_templates.side_effect = ValueError("Document type not found")
        mock_engine_class.return_value = mock_engine
    ...
    @patch('os.remove')
    def test_generate_document_success(self, mock_remove, mock_exists, mock_tempfile, mock_engine_class, client, sample_resume_data):
    ...
    @patch('resume_agent_template_engine.api.app.TemplateEngine')
    def test_generate_document_invalid_template(self, mock_engine_class, client, sample_resume_data):
    ...
    @patch('resume_agent_template_engine.api.app.TemplateEngine')
    def test_generate_document_invalid_document_type(self, mock_engine_class, client, sample_resume_data):
    ...
    @patch('resume_agent_template_engine.api.app.TemplateEngine')
    def test_generate_document_engine_error(self, mock_engine_class, client, sample_resume_data):
