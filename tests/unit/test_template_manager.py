...
"""
    ...
    def test_generate_pdf_with_output_path(self, mock_engine_class):
        ...
        mock_engine.export_to_pdf.assert_called_once_with(
            "resume", "classic", data, "/path/to/output.pdf"
        )
    ...
    def test_generate_pdf_default_output_path(self, mock_engine_class):
        ...
        mock_engine.export_to_pdf.assert_called_once_with(
            "resume", "classic", data, "resume_classic.pdf"
        )
...
"""
    ...
    @pytest.mark.skip(
        reason="Test relies on internal implementation details of deprecated TemplateManager"
    )
