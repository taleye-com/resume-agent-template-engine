...
class TestAPIEndpointsE2E:
        ...
        with patch('resume_agent_template_engine.api.app.TemplateEngine') as mock_engine_class:
            ...
            with patch('tempfile.NamedTemporaryFile') as mock_temp, \
                ...
                try:
                    ...
                    generate_response = client.post("/generate", json=generation_request)
                    ...
                    assert generate_response.headers["content-type"] == "application/pdf"
    ...
    def test_complete_cover_letter_generation_workflow(self, client, sample_cover_letter_data):
    ...
    def test_template_management_workflow(self, client):
        ...
        with patch('resume_agent_template_engine.api.app.TemplateEngine') as mock_engine_class:
            ...
            mock_engine.get_available_templates.return_value = ["classic", "modern", "creative"]
    ...
    def test_concurrent_document_generation(self, client, sample_resume_data, sample_cover_letter_data):
        ...
        with patch('resume_agent_template_engine.api.app.TemplateEngine') as mock_engine_class:
            ...
            with patch('tempfile.NamedTemporaryFile') as mock_tempfile, \
                ...
                try:
                    ...
                    assert response.status_code == 200
                    assert (end_time - start_time) < 5.0  # Should generate within 5 seconds
